package com.md5importer.model.mesh.primitive;
 ...
 * @version Modified date: 04-03-2009 17:23 EST
 */
public class Vertex implements Serializable, IVertex {
	...
	public IVertex clone(IWeight[] clonedWeights) {
		...
		IVertex clone = new Vertex(this.index, this.textureCoords.clone(), weights, this.usedTimes, this.normal.clone(), this.position.clone());
		clone.setNormalReference(this.normalRef);
		return clone;
	}
}
