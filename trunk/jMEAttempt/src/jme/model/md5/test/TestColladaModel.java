 ...
 *
 */
public class TestColladaModel extends SimpleGame {
    private static final Logger logger = Logger
            .getLogger(TestColladaModel.class.getName());
    
    AnimationController ac;
    boolean boneOn = false;
    public static void main(String[] args) {
        TestColladaModel app = new TestColladaModel();
    ...
    protected void simpleInitGame() {
        try {
            ResourceLocatorTool.addResourceLocator(
                    ...
                    new SimpleResourceLocator(TestColladaModel.class
        ...
        InputStream mobboss = TestColladaModel.class.getClassLoader()
        ...
        InputStream animation = TestColladaModel.class.getClassLoader()
        ...
        Box b = new Box("", new Vector3f(), 3,3,3);
        b.setModelBound(new BoundingBox());
        b.updateModelBound();
        ((Bone)((Bone)((Bone)skel.getChild(0)).getChild(0)).getChild(0)).attachChild(b);
